...
export default class Rectangle extends BaseTool {
  ...
  public onPointerMove(point: Point2D, context: CanvasRenderingContext2D): void {
    ...
    const linePoints = [
      ...drawLinePoints(last.x, last.y, point.x, last.y),
      ...drawLinePoints(last.x, last.y, last.x, point.y),
      ...drawLinePoints(last.x, point.y, point.x, point.y),
      ...drawLinePoints(point.x, point.y, point.x, last.y),
    ]
